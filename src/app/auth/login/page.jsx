    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans antialiased">
      ...
      <div className="sm:mx-auto w-full sm:max-w-md px-4">
        ...
        <p className="mt-2 text-center text-sm text-slate-500">
          New to HireLoop?{' '}
          <Link href="/auth/signup" className="font-medium text-blue-600 hover:text-blue-500 hover:underline animate-pulse">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="rememberMe" className="ml-2 block text-xs text-slate-600 font-medium select-none">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-2 text-slate-400 font-medium tracking-wider">Or secure continue with</span>
              </div>
            </div>
